/******/ (() => {
  ...
  \*********************************/
      /***/ (
        ...
        /* harmony import */ var _Objects__WEBPACK_IMPORTED_MODULE_1__ =
        ...
        class Camera {
          ...
          drawSprites(player, map, columnProps) {
            ...
            const { resolution } = this; // calculate each sprite distance to player
            ...
            const sprites = Array.prototype.slice
              ...
              .map((sprite) => {
                ...
                let angleRelativeToPlayerView =
                  player.direction - angleToPlayer;
          ...
          drawDie() {
            ...
            for (let i = 1; i < 30; i++) {
              w = (0, _utils_calc__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(
                0,
                11,
              );
              h = (0, _utils_calc__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(
                0,
                9,
              );
              this.ctx.fillText(
  ...
  \*******************************/
      /***/ (
        ...
        /* harmony import */ var _Sounds__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./Sounds */ './js/components/Sounds.js');
        /* harmony import */ var _Noises__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./Noises */ './js/components/Noises.js');
        /* harmony import */ var _Person__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./Person */ './js/components/Person.js');
        /* harmony import */ var _Player__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(/*! ./Player */ './js/components/Player.js');
        /* harmony import */ var _Camera__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(/*! ./Camera */ './js/components/Camera.js');
        /* harmony import */ var _Controls__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(/*! ./Controls */ './js/components/Controls.js');
        /* harmony import */ var _GameLoop__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(/*! ./GameLoop */ './js/components/GameLoop.js');
        /* harmony import */ var _ObjSounds__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(
            /*! ./ObjSounds */ './js/components/ObjSounds.js',
          );
        /* harmony import */ var _utils_calc__WEBPACK_IMPORTED_MODULE_10__ =
          __webpack_require__(/*! ../utils/calc */ './js/utils/calc.js');
        /* harmony import */ var _utils_sound__WEBPACK_IMPORTED_MODULE_11__ =
          __webpack_require__(/*! ../utils/sound */ './js/utils/sound.js');
        /* harmony import */ var _data_assets__WEBPACK_IMPORTED_MODULE_12__ =
          __webpack_require__(/*! ../../data/assets */ './data/assets.js');
        /* harmony import */ var _data_sounds__WEBPACK_IMPORTED_MODULE_13__ =
        ...
        class Game {
          constructor() {
            ...
            this.papers =
              _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.papers;
            this.trees =
              _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.rain_trees;
            this.bushes =
              _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.rain_bushes;
            this.sounds = new _Sounds__WEBPACK_IMPORTED_MODULE_2__.default(
              this,
            );
          }
          ...
          loadGame() {
            ...
            this.camera = new _Camera__WEBPACK_IMPORTED_MODULE_6__.default(
              canvasBlock,
              this.RESOLUTION,
              0.8,
              this.mode,
            ...
            this.loop = new _GameLoop__WEBPACK_IMPORTED_MODULE_8__.default(
              this,
              this.endGame,
            );
            this.noises = new _Noises__WEBPACK_IMPORTED_MODULE_3__.default();
            this.obj_sounds =
              new _ObjSounds__WEBPACK_IMPORTED_MODULE_9__.default(
                this,
                this.map,
                this.mode,
              );
            ...
            this.controls = new _Controls__WEBPACK_IMPORTED_MODULE_7__.default(
              this.player,
            );
            this.setMode();
            this.addPeople();
          ...
          endGame() {
            const endSong = (0,
            _utils_calc__WEBPACK_IMPORTED_MODULE_10__.getRandomInt)(0, 2);
          ...
          setMode() {
            ...
            if (winter) {
              ...
              this.trees =
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.trees;
              this.bushes =
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.bushes;
          ...
          addPeople() {
            for (let i = 0; i < this.PPL_NUM; i++) {
              const x = (0,
              _utils_calc__WEBPACK_IMPORTED_MODULE_10__.getRandomInt)(
                2,
                this.PPL_XY,
              );
              const y = (0,
              ...
              const picNum = (0,
              _utils_calc__WEBPACK_IMPORTED_MODULE_10__.getRandomInt)(1, 5);
              this.map.addObject(
                new _Person__WEBPACK_IMPORTED_MODULE_4__.default(
                  this.player,
                  this.map,
                  x,
                  y,
          ...
          changeAmbient() {
            if (this.noises.noisesEnd) {
              const next = (0,
              _utils_calc__WEBPACK_IMPORTED_MODULE_10__.getRandomInt)(0, 4);
          ...
          setToWinter() {
            this.mode = {
              ...
              particlesHeight: 6,
              fence_door:
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.mode
                  .fenceDoor,
              fence_texture:
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.mode.snow
                  .fence,
              sky_texture:
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.mode.snow
                  .sky,
            ...
            this.mode = {
              ...
              fence_door:
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.mode
                  .fenceDoor,
              fence_texture:
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.mode.rain
                  .fence,
              sky_texture:
                _data_assets__WEBPACK_IMPORTED_MODULE_12__.default.mode.rain
                  .sky,
          ...
          static loadSounds() {
            (0, _utils_sound__WEBPACK_IMPORTED_MODULE_11__.preloadSounds)();
          }
          ...
          enableMenuSounds() {
            ...
            const stopHandler = (name, unmute) => {
              soundmanager2__WEBPACK_IMPORTED_MODULE_0__.soundManager.stop(
                name,
              );
              unmute &&
            ...
            const startAboutUsHandler = () =>
              startHandler(ABOUT_US.id, PIANO_MENU.id);

            const stopAboutUsHandler = () =>
              stopHandler(ABOUT_US.id, PIANO_MENU.id);
  ...
  \******************************/
      /***/ (
        ...
        /* harmony import */ var _Objects__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./Objects */ './js/components/Objects.js');
        /* harmony import */ var _Person__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ./Person */ './js/components/Person.js');
        ...
        class Map {
          constructor(size, mode) {
            ...
            this.skybox = new _Bitmap__WEBPACK_IMPORTED_MODULE_1__.default(
              mode.sky_texture,
              2000,
              750,
            );
            ...
            this.wallTexture = new _Bitmap__WEBPACK_IMPORTED_MODULE_1__.default(
              mode.wall_texture,
              512,
              512,
            );
          ...
          addTrees(trees, col, row) {
            if (this.get(col, row) === 0) {
              ...
              this.addObject(
                new _Objects__WEBPACK_IMPORTED_MODULE_2__.default({
                  texture: new _Bitmap__WEBPACK_IMPORTED_MODULE_1__.default(
                    trees[num].texture,
                    trees[num].width,
                    trees[num].height,
                  ),
          ...
          addBushes(bushes, col, row) {
            if (this.get(col, row) === 0) {
              const num = (0,
              _utils_calc__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(0, 5);
              this.addObject(
                new _Objects__WEBPACK_IMPORTED_MODULE_2__.default({
                  texture: new _Bitmap__WEBPACK_IMPORTED_MODULE_1__.default(
                    bushes[num].texture,
          ...
          buildMap(trees, bushes) {
            ...
            for (let i = 0; i < this.size * this.size; i++) {
              ...
              col = i - this.size * row; // Generate the labirinth
          ...
          update() {
            this.objects.forEach((item) => {
              if (
                item instanceof _Person__WEBPACK_IMPORTED_MODULE_3__.default
              ) {
                item.logic();
              }
            });
  ...
  \*********************************/
      /***/ (
        ...
        /* harmony import */ var _utils_sound__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../utils/sound */ './js/utils/sound.js');
        /* harmony import */ var _data_sounds_json__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../../data/sounds.json */ './data/sounds.json',
          );
        ...
        class Noises {
          constructor() {
            ...
            this.noises = {
              ...
              1: _data_sounds_json__WEBPACK_IMPORTED_MODULE_1__.RANDOM
                .JUST_HORROR,
              2: _data_sounds_json__WEBPACK_IMPORTED_MODULE_1__.RANDOM
                .WEIRD_NOISES,
              3: _data_sounds_json__WEBPACK_IMPORTED_MODULE_1__.RANDOM
                .SCARY_PIANO,
            };
          }
          ...
          playNoises(noiseNum) {
            ...
            (0, _utils_sound__WEBPACK_IMPORTED_MODULE_0__.playSM)(
              this.noises[noiseNum],
              {
                multiShotEvents: true,
                onfinish: () => {
                  this.noisesEnd = true;
  ...
  \*********************************/
      /***/ (
        ...
        /* harmony import */ var _Paper__WEBPACK_IMPORTED_MODULE_0__ =
        ...
        class Person {
          ...
          logic() {
            if (this.alive) {
              if (this.count > 270) {
                this.direction += (0,
                _utils_calc__WEBPACK_IMPORTED_MODULE_2__.getRandomFloat)(
                  -(this.CIRCLE / 6),
                  this.CIRCLE / 6,
                );
                this.count = 0;
  ...
  \*********************************/
      /***/ (
        ...
        /* harmony import */ var _utils_calc__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ../utils/calc */ './js/utils/calc.js');
        /* harmony import */ var _Paper__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./Paper */ './js/components/Paper.js');
        ...
        class Player {
          constructor(origin) {
            ...
            this.right_hand = new _Bitmap__WEBPACK_IMPORTED_MODULE_3__.default(
            ...
            this.left_hand = new _Bitmap__WEBPACK_IMPORTED_MODULE_3__.default(
          ...
          rotate(angle) {
            this.direction =
              (this.direction + angle + this.CIRCLE) % this.CIRCLE;
          }
          ...
          attack() {
            ...
            this.map.objects.some((item) => {
              if (
                item instanceof _Person__WEBPACK_IMPORTED_MODULE_4__.default &&
                item.alive
              ) {
                victim = item;
                x = this.x - victim.x;
          ...
          placePaper() {
            if (this.map.papers >= this.PAPER_NUM) {
              ...
              if (
                ...
                const paperType = (0,
                _utils_calc__WEBPACK_IMPORTED_MODULE_1__.getRandomInt)(0, 8);
                this.map.addObject(
                  new _Paper__WEBPACK_IMPORTED_MODULE_2__.default(
                    this.x,
                    this.y,
      ...
      /***/ (
        ...
        class Sounds {
          constructor(game) {
            ...
            this.sound_end = true;
            this.ending = {
              0: _data_sounds__WEBPACK_IMPORTED_MODULE_2__.default.END.COME_OUT
                .id,
          ...
          playEnding(endingNum) {
            (0, _utils_sound__WEBPACK_IMPORTED_MODULE_1__.playSM)(
              this.ending[endingNum],
              {
        ...
        const SLIDE_CONFIG = {
          [SLIDE_MAP.LEFT]: {
            title: document.querySelector(
              `.slider-${SLIDE_MAP.LEFT} .slider-title`,
            ),
            data: document.querySelector(
              `.slider-${SLIDE_MAP.LEFT} .slider-data`,
            ),
          },
          [SLIDE_MAP.RIGHT]: {
            title: document.querySelector(
              `.slider-${SLIDE_MAP.RIGHT} .slider-title`,
            ),
            data: document.querySelector(
              `.slider-${SLIDE_MAP.RIGHT} .slider-data`,
            ),
          },
        };
  ...
  \***********************/
      /***/ (
        ...
        /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ =
          __webpack_require__.p + 'assets/video/intro.mp4';
  ...
  \********************/
    ...
    /* harmony import */ var _components_Game__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./components/Game */ './js/components/Game.js');
    /* harmony import */ var _img_intro_mp4__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(/*! ../img/intro.mp4 */ './img/intro.mp4');
    /* harmony import */ var _script__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(/*! ./script */ './js/script.js');
    /* harmony import */ var _script__WEBPACK_IMPORTED_MODULE_3___default =
      /*#__PURE__*/ __webpack_require__.n(_script__WEBPACK_IMPORTED_MODULE_3__);
    ...
    const init = () => {
      ...
      _components_Game__WEBPACK_IMPORTED_MODULE_1__.default.loadSounds();
