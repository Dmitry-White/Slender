...
class Person {
    constructor(player, map, x, y, pic_num, CIRCLE) {
        ...
        this.x = x;
        this.y = y;
        this.color = '#cf3c8c', this.texture = new __WEBPACK_IMPORTED_MODULE_0__Bitmap_js__["a" /* Bitmap */]('img/girl/girl-' + pic_num + '.png', 114, 300), this.pic_num = pic_num;
    ...
    logic() {
        if (this.alive) {
            ...
            if (this.count > 270) {
                this.direction = this.direction + __WEBPACK_IMPORTED_MODULE_1__Calc_js__["a" /* Calc */].getRandomFloat(-(this.CIRCLE / 6), this.CIRCLE / 6);
                this.count = 0;
            };
            //this.search();
            //this.turn();
    ...
    die() {
        this.texture = new __WEBPACK_IMPORTED_MODULE_0__Bitmap_js__["a" /* Bitmap */]('img/girl/girl_die.gif', 114, 300);
        setTimeout(() => {
            this.texture = new __WEBPACK_IMPORTED_MODULE_0__Bitmap_js__["a" /* Bitmap */]('img/girl/girl3-' + this.pic_num + '.png', 300, 56);
            this.height = .2;
            this.width = 0.7;
        }, 7000);
    }
    ...
    move(url) {
        if (this.count % 10 === 0) {
            if (this.count % 20 === 0) {
                this.texture = new __WEBPACK_IMPORTED_MODULE_0__Bitmap_js__["a" /* Bitmap */](url + '2-' + this.pic_num + '.png', 114, 300);
            } else this.texture = new __WEBPACK_IMPORTED_MODULE_0__Bitmap_js__["a" /* Bitmap */](url + '-' + this.pic_num + '.png', 114, 300);
        };
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Game_js__ = __webpack_require__(6);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Map_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Calc_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Sounds_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Noises_js__ = __webpack_require__(8);
...
class Game {
    constructor() {
        ...
        this.sounds = new __WEBPACK_IMPORTED_MODULE_2__Sounds_js__["a" /* Sounds */]();
        ...
        this.camera = new __WEBPACK_IMPORTED_MODULE_7__Camera_js__["a" /* Camera */](document.getElementById('display'), 640, 0.8, this.mode, this.CIRCLE);
    }

    loadGame() {
        this.map = new __WEBPACK_IMPORTED_MODULE_0__Map_js__["a" /* Map */](32, this.mode);
        this.obj_sounds = new __WEBPACK_IMPORTED_MODULE_11__ObjSounds_js__["a" /* ObjSounds */](this, this.map, this.mode);
        this.player = new __WEBPACK_IMPORTED_MODULE_5__Player_js__["a" /* Player */]({ x: 1.5, y: 1.5, direction: 1, game: this });
    ...
    addPeople() {
        for (let i = 0; i < 7; i++) {
            let x = __WEBPACK_IMPORTED_MODULE_1__Calc_js__["a" /* Calc */].getRandomInt(2, 30);
            let y = __WEBPACK_IMPORTED_MODULE_1__Calc_js__["a" /* Calc */].getRandomInt(2, 30);
...
class Player {
    constructor(origin) {
        ...
        this.right_hand = new __WEBPACK_IMPORTED_MODULE_1__Bitmap_js__["a" /* Bitmap */]('img/slender/knife_hand.png', 200, 200);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Sounds_js__ = __webpack_require__(4);
