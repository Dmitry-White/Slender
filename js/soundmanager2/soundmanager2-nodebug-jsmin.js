...
(function (g, h) {
  function v(gb, v) {
    function Z(b) {
      return (
        c.preferFlash && z && !c.ignoreFlash && c.flash[b] !== h && c.flash[b]
      );
    }
    function q(b) {
      return function (c) {
    ...
    var M,
      ...
      ab =
        !Oa.match(/usehtml5audio/i) &&
        !Oa.match(/sm2-ignorebadua/i) &&
        la &&
        !t.match(/silk/i) &&
        t.match(/OS\sX\s10_6_([3-7])/i),
    ...
    this.setup = function (b) {
      ...
      b &&
        (e && Q && b.url !== h && c.beginDelayedInit(),
        Q || b.url === h || 'complete' !== n.readyState || setTimeout(F, 1));
      Ga = !0;
      return c;
    };
    ...
    this.canPlayLink = function (b) {
      return b.type !== h && b.type && c.canPlayMIME(b.type)
        ? !0
        : c.canPlayURL(b.href);
    };
    ...
    this.ontimeout = function (b, c) {
      if ('function' === typeof b)
        c || (c = g), sa('ontimeout', b, c), E({ type: 'ontimeout' });
    ...
    M = function (b) {
      ...
      this.load = function (b) {
        ...
        b !== h
          ...
          : ((b = a.options),
            (a._iO = b),
            v && v !== a.url && ((a._iO.url = a.url), (a.url = null)));
      ...
      this.start = this.play = function (b, e) {
        ...
        if (1 === a.playState && !a.paused && ((d = a._iO.multiShot), !d))
          return a.isHTML5 && a.setPosition(a._iO.position), a;
        b.url &&
          b.url !== a.url &&
        ...
        a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position)
          ...
          : ((a._iO = w(b, a._iO)),
            ...
            (a.paused = !1),
            (a.position =
              a._iO.position === h || isNaN(a._iO.position)
                ? 0
                : a._iO.position),
            ...
            a.isHTML5
              ? 2 > a.instanceCount
                ...
                : ((f = new Audio(a._iO.url)),
                  ...
                  r.add(f, 'ended', g),
                  a._iO.volume !== h &&
                    (f.volume = Math.max(0, Math.min(1, a._iO.volume / 100))),
                  a.muted && (f.muted = !0),
      ...
      this.pause = function (b) {
        ...
        a.isHTML5
          ...
          : (b || b === h) && k._pause(a.id, a._iO.multiShot);
      ...
      this._resetOnPosition = function (a) {
        ...
        if (!b) return !1;
        for (--b; 0 <= b; b--)
          (c = l[b]), c.fired && a <= c.position && ((c.fired = !1), u--);
        return !0;
      };
      A = function () {
        var b = a._iO,
      ...
      L = function () {
        ...
        for (b in B)
          B.hasOwnProperty(b) && a._a && a._a.addEventListener(b, B[b], !1);
        return !0;
      };
      fb = function () {
        var b;
        ...
        for (b in B)
          B.hasOwnProperty(b) && a._a && a._a.removeEventListener(b, B[b], !1);
      };
      ...
      this._whileplaying = function (b, c, d, e, f) {
        ...
        1 === a.playState &&
          (a.isHTML5 ||
            ...
            !a.isBuffering ||
            a._onbufferchange(0),
          g.whileplaying && g.whileplaying.apply(a));
        return !0;
      };
    ...
    w = function (b, e) {
      ...
      for (f in a)
        a.hasOwnProperty(f) &&
          d[f] === h &&
          (d[f] =
            'object' !== typeof a[f] || null === a[f] ? a[f] : w(d[f], a[f]));
      return d;
    };
    Y = function (b, c) {
    ...
    B = {
      ...
      canplay: q(function () {
        ...
        if (!b._html5_canplay) {
          ...
          b._onbufferchange(0);
          c =
            b._iO.position === h || isNaN(b._iO.position)
              ? null
              : b._iO.position / 1e3;
    ...
    ja = function (b) {
      return b && (b.type || b.url || b.serverURL)
        ? b.serverURL || (b.type && Z(b.type))
          ...
          : b.type
          ? X({ type: b.type })
          : X({ url: b.url }) || c.html5Only || b.url.match(/data:/i)
        : !1;
    };
    ka = function (b) {
      var e;
    ...
    X = function (b) {
      ...
      if (!C) {
        ...
        for (a in d)
          d.hasOwnProperty(a) &&
            (C.push(a), d[a].related && (C = C.concat(d[a].related)));
        C = new RegExp('\\.(' + C.join('|') + ')(\\?.*)?$', 'i');
      }
      (a = e ? e.toLowerCase().match(C) : null) && a.length
        ? (a = a[1])
        : b &&
          ((e = b.indexOf(';')),
    ...
    Ya = function () {
      function b(a) {
        ...
        if (a instanceof Array) {
          ...
          for (b = a.length; k < b; k++)
            if (c.html5[a[k]] || e.canPlayType(a[k]).match(c.html5Test))
              (d = !0),
                (c.html5[a[k]] = !0),
                (c.flash[a[k]] = !!a[k].match(cb));
          b = d;
        } else
          (a =
      ...
      for (d in g)
        if (
          ...
          for (k = g[d].related.length - 1; 0 <= k; k--)
            (f['audio/' + g[d].related[k]] = f[d]),
              (c.html5[g[d].related[k]] = f[d]),
              (c.flash[g[d].related[k]] = f[d]);
    ...
    ya = function (b) {
      for (var c in b)
        b.hasOwnProperty(c) && 'function' === typeof b[c] && (b[c] = oa);
    };
    za = function (b) {
      b === h && (b = !1);
      (A || b) && c.disable(b);
      ...
      c.html5Only ||
        (c.ok()
          ...
          : (u &&
            ...
            (c.didFlashBlock = !0),
            E({ type: 'ontimeout', ignoreInit: !0, error: e }),
            J(e)));
    };
    sa = function (b, c, d) {
      x[b] === h && (x[b] = []);
    ...
    E = function (b) {
      ...
      if (
        (!l && b && !b.ignoreInit) ||
        ('ontimeout' === b.type && (c.ok() || (A && !b.ignoreInit)))
      )
        return !1;
    ...
    Ta = function (b) {
      b._hasTimer ||
        ...
        !ma &&
          ...
          (null === U &&
            0 === ha &&
            (U = setInterval(Va, c.html5PollingInterval)),
          ha++));
    };
    Ua = function (b) {
      b._hasTimer &&
        ((b._hasTimer = !1), !ma && c.html5PollingInterval && ha--);
    };
    Va = function () {
      var b;
      if (null === U || ha)
    ...
    J = function (b) {
      ...
      'function' === typeof c.onerror &&
        c.onerror.apply(g, [{ type: b.type !== h ? b.type : null }]);
    ...
    ea = function (b, e) {
      ...
      if (N && O) return !1;
      if (c.html5Only)
        return ua(), (c.oMC = aa(c.movieID)), pa(), (O = N = !0), !1;
      var a = e || c.url,
        f = c.altURL || a,
        g = wa(),
        k = K(),
      ...
      null !== c.wmode &&
        (t.match(/msie 8/i) || (!D && !c.useHighPerformance)) &&
        navigator.platform.match(/win32|win64/i) &&
        (V.push(I.spcWmode), (c.wmode = null));
      g = {
        name: b,
        id: b,
        src: e,
      ...
      if (D)
        ...
        for (l in ((a = n.createElement('embed')), g))
          g.hasOwnProperty(l) && a.setAttribute(l, g[l]);
      xa();
      k = K();
      if ((g = wa()))
        if (((c.oMC = aa(c.movieID) || n.createElement('div')), c.oMC.id))
          (p = c.oMC.className),
            (c.oMC.className =
              (p ? p + ' ' : 'movieContainer') + (k ? ' ' + k : '')),
            c.oMC.appendChild(a),
            D &&
              ((l = c.oMC.appendChild(n.createElement('div'))),
    ...
    da = function () {
      ...
      k ||
        (R
          ? (D ? (c.oMC.innerHTML = Aa) : c.oMC.appendChild(R),
            (R = null),
            (N = !0))
          : ea(c.id, c.url),
        (k = c.getMovie(c.id)));
    ...
    P = function (b) {
      ...
      if (A || b)
        c.useFlashBlock &&
          ...
          E({ type: 'ontimeout', error: d, ignoreInit: !0 }),
          J(d),
          (e = !1);
    ...
    pa = function () {
      ...
      if (c.html5Only)
        return (
          l || (r.remove(g, 'load', c.beginDelayedInit), (c.enabled = !0), P()),
          !0
        );
      da();
      try {
        k._externalInterfaceTest(!1),
          Ra(!0, c.flashPollingInterval || (c.useHighPerformance ? 10 : 50)),
          c.debugMode || k._disableDebug(),
          (c.enabled = !0),
          c.html5Only || r.add(g, 'unload', oa);
      } catch (b) {
    ...
    Da = function () {
      'complete' === n.readyState &&
        (F(), n.detachEvent('onreadystatechange', Da));
      return !0;
    };
    va = function () {
      qa = !0;
    ...
    n.addEventListener
      ...
      : n.attachEvent
      ? n.attachEvent('onreadystatechange', Da)
      : J({ type: 'NO_DOM2_EVENTS', fatal: !0 });
  }
  if (!g || !g.document)
    throw Error(
        ...
        return {
          ...
          getInstance: function (h) {
            !g.soundManager &&
              ...
              ((h = h(v)), h instanceof v && (g.soundManager = h));
